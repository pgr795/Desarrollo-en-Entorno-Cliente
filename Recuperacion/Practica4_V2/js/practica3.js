    ...
    if(codigo!="" && nombre!=""){
        ...
        if(codigoValido && nombreValido){
            ...
            while(validar && cont2<longitud){
                ...
                if(parseInt(codigo,10) < parseInt(celdas.eq(0).text(),10)){
                    validar=false;
                    $(linea).before("<tr><td>"+codigo+"</td><td>"+nombre+"</td></tr>");
                }
                else if(parseInt(codigo,10)==parseInt(celdas.eq(0).text(),10)){
                    validar=false;
...
function borrar() {
    ...
    if(codigo!=""){
        ...
        while(noExiste && indice<filas.length){
           let fila=$(filas).eq(indice).children("td");
...
function BorrarFila() {
    ...
    let filas=$("#tabla>tbody>tr");
    if(numero!=""){
        if(numero<=filas.length && numero > 0){
