...
function proceso(){
	...
	// tercer paso establecer conexión con el servidor
		...
		// mediante get
	peticion.open("POST","php/ajax-06.php");
...
function procesar(){
	if (peticion.readyState==4)
		if (peticion.status==200){
			...
			let ape=misdatos.getElementsByTagName("apellidos").item(0).textContent;
			let suel=misdatos.getElementsByTagName("sueldo").item(0).textContent;
